...
pub trait ServiceAccess {
    fn db<F, TResult>(&self, operation: F) -> TResult where F: FnOnce(&UnQLite) -> TResult;

    fn db_mut<F, TResult>(&self, operation: F) -> TResult where F: FnOnce(&mut UnQLite) -> TResult;
}
